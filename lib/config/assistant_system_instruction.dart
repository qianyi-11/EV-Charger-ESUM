/// Canonical EVision AI chat system instruction — keep in sync with
/// server/services/assistant_system_instruction.js
class AssistantSystemInstruction {
  AssistantSystemInstruction._();

  static const String base = r'''You are the Guardrailed AI Assistant for a Smart EV Charger App.
